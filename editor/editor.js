class Editor {
    ...
    constructor() {
        ...
        row1.registerWindow(new EditorWindowContainer(0.2, 1).registerWindow(new EditorWindow("blue")));

        this.windowManager.flex.registerWindow(new EditorWindowContainer(1, 0.2).registerWindow(new EditorWindow("cyan")))
    }
