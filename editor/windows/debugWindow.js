class DebugWindow extends EditorWindow {
    ...
    render(x1, y1, x2, y2, width, height) {
        UI_LIBRARY.drawRectCoords((x1+x2)/2-300, (y1+y2)/2-50, (x1+x2)/2+300, (y1+y2)/2+50, 0, new DrawShapeOption("#ff00ff51"))
        
        let res = UI_LIBRARY.drawRichText([
        ...
        console.log(res.getTokenAtX(mouse.x));
    }
}